...
fun HttpServerResponse.endWithJson(obj: Any? = null, code: HttpResponseStatus = HttpResponseStatus.OK) {
  this.setStatusCode(code.code()).putHeader(HttpHeaders.CONTENT_TYPE, HttpHeaders.createOptimized("application/json; charset=utf-8")).end(Json.encode(ResponseWithCode(obj, code.code())))
}
